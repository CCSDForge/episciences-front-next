...
export default async function SectionDetailsPage(props: {
  ...
  let rawSection: Awaited<ReturnType<typeof fetchSection>>;
  ...
  try {
    ...
    [rawSection, activeJournal] = await Promise.all([
  ...
  if (rawSection.rvid !== undefined && rawSection.rvid !== activeJournal?.id) {
