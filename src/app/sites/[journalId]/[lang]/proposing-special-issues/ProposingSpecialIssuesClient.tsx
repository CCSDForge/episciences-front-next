...
export default function ProposingSpecialIssuesClient({
  initialPage,
  lang,
  breadcrumbLabels,
}: ProposingSpecialIssuesClientProps): React.JSX.Element {
  ...
  const title = titleResult.value || t('pages.proposingSpecialIssues.title');
  ...
  return (
    <MarkdownPageWithSidebar
      ...
      breadcrumbLabels={{
        ...
        current: breadcrumbLabels?.current || t('pages.proposingSpecialIssues.title'),
      }}
      lang={lang}
      noContentMessage={t('pages.proposingSpecialIssues.noContent')}
