...
describe('volume utilities', () => {
  ...
  describe('formatVolume', () => {
    ...
    it('should generate correct download link URL', () => {
      ...
      expect(result.downloadLink).toBe('https://epiderminfo.episciences.org/volumes-full/123/123.pdf')
    })
    ...
    it('should generate tile image URL when tile metadata exists', () => {
      ...
      expect(result.tileImageURL).toBe('https://journal.episciences.org/public/volumes/123/tile.png')
    })
    ...
    it('should use language-specific tile title', () => {
      ...
      expect(result.tileImageURL).toBe('https://journal.episciences.org/public/volumes/123/tuile.png')
    })
    ...
    it('should handle multiple metadata entries and find tile', () => {
      ...
      expect(result.tileImageURL).toBe('https://journal.episciences.org/public/volumes/123/thumbnail.png')
    })
