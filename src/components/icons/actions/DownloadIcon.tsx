 ...
 *
 * A reusable SVG icon component for displaying a download icon (file with down arrow).
 * Commonly used for PDF downloads, file exports, and document downloads.
 *
...
export const DownloadRedIcon = (props: Omit<DownloadIconProps, 'color'>) => (
  <DownloadIcon {...props} color="#C1002A" />
);

export const DownloadBlueIcon = (props: Omit<DownloadIconProps, 'color'>) => (
  <DownloadIcon {...props} color="#2563EB" />
);
