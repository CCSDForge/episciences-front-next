 ...
 * User Icon Component
 *
 * A reusable SVG icon component for displaying a user avatar/profile icon.
 * Commonly used as a fallback for missing profile photos and user representations.
 *
