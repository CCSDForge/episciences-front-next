/**
 * ROR (Research Organization Registry) Icon Component
 *
 * A reusable SVG icon component for displaying the ROR logo.
 * Used for institutional identifiers and research organization links.
 *
...
export default function RorIcon({
  color = 'currentColor',
  size = 164,
  className = '',
  ariaLabel,
    ...
    >
      ...
      <g transform="matrix(1,0,0,1,-0.945,-0.815)">
        <path
          ...
          style={{ fill: 'rgb(83,186,161)', fillRule: 'nonzero' }}
        />
        <path
