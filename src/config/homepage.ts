...
export const blocksConfiguration = (): BlockConfig[] => [
  {
    ...
    order: parseInt(
      process.env.NEXT_PUBLIC_JOURNAL_HOMEPAGE_LATEST_ARTICLES_CAROUSEL_ORDER || '1',
      10
    ),
  },
  {
  ...
  },
  {
    ...
    order: parseInt(
      process.env.NEXT_PUBLIC_JOURNAL_HOMEPAGE_LATEST_ACCEPTED_ARTICLES_CAROUSEL_ORDER || '7',
      10
    ),
  },
];
