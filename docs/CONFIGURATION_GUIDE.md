...
## 3. Two Layers of Configuration

The application uses two distinct layers that must not be mixed.

### Layer 1 — Shared infrastructure (process-level)
...
### Layer 2 — Journal-specific configuration (runtime)
